...
const (
	...
	//	myRedirectURL = "urn:ietf:wg:oauth:2.0:oob"
...
func main() {
	...
	fmt.Printf("Authorization successful, token.txt update")
...
func get(app *appVars, url string) {
	// try something
	fmt.Println("\nGET", url)
...
func aget(app *appVars, url string) {
	// try something
	fmt.Println("\nGET", url)
